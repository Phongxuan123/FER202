    ...
    <>
      ...
      >
        <Container fluid className="px-0">
          <Navbar.Brand className="d-flex align-items-center gap-2 mb-0 fw-bold text-dark">
            PersonalBudget
          </Navbar.Brand>

          <div className="d-flex align-items-center gap-2 ms-auto" style={{ fontSize: '14px' }}>
